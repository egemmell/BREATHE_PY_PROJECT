...
IHD_AGE_FILE         = "data/raw/baseline_health_outcomes/ihd_mortality_county_2019_CDC_age.csv"
IHD_AGE_SEX_FILE     = "data/raw/baseline_health_outcomes/ihd_mortality_county_2019_CDC_age_sex.csv"
IHD_ALL_AGES_FILE    = "data/raw/baseline_health_outcomes/ihd_mortality_county_2019_CDC_all_ages.csv"
IHD_ST_AGE_FILE      = "data/raw/baseline_health_outcomes/ihd_mortality_state_2019_CDC_age.csv"
IHD_ST_AGE_SEX_FILE  = "data/raw/baseline_health_outcomes/ihd_mortality_state_2019_CDC_age_sex.csv"
IHD_ST_RACE_FILE     = "data/raw/baseline_health_outcomes/ihd_mortality_state_2019_CDC_age_sex_race.csv"
...
USALEEP_OUT     = "data/processed/ac_mortality_ct_tract_2020_USALEEP.parquet"
ALRI_OUT        = "data/processed/alri_2019_hcai.parquet"
IHD_OUT         = "data/processed/ihd_mortality_county_state_2019_CDC.parquet"
...
# Analysis outputs
HIA_RESULTS_OUT    = "output/hia_results_runs_long.parquet"
HIA_TOTALS_OUT     = "output/hia_totals_by_run.parquet"
HIA_BY_AGE_OUT     = "output/hia_by_age.parquet"
HIA_BY_GEO_OUT     = "output/hia_by_geography.parquet"
HIA_SOURCE_OUT     = "output/hia_source_sensitivity.parquet"
HIA_STRATA_OUT     = "output/hia_strata_sensitivity.parquet"
